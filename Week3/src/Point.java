...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        if (this.equals(that) || (this.x == that.x && this.y == that.y)) return Double.NEGATIVE_INFINITY;
    ...
    public int compareTo(Point that) {
        if (this.equals(that) || (this.x == that.x && this.y == that.y)) return 0;
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(comparator.compare(b, c));
